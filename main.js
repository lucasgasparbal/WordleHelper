...
class ConfirmedLetter {
    constructor(letter, position) {
        ...
        this.validateWord = function (word) {
            ...
            return (wordLower.charAt(position) === letter);
        };
    }
}
    ...
    constructor(letter, positions) {
        ...
        this.validateWord = function (word) {
            ...
            for (let i = 0; i < positions.length; i++) {
                if (wordLower.charAt(positions[i]) === letter) {
                    return false;
                }
            }
            return true;
...
function createValidWords(conditions, bannedLetters){

    let validWords = [];

    for(let word of words){
        
        if(wordIsValid(word,conditions,bannedLetters)){
...
function wordIsValid(word, conditions, bannedLetters){
...
function test(){
    console.log(createValidWords([confirmedLetterTest,presentLetterTest],["o","u","g","d"]));
}

const confirmedLetterTest = new ConfirmedLetter("r",4);

const presentLetterTest = new PresentLetter("e",[1,2,0])